...
```{r, results = 'asis'}
data("tx2gene")
pander::pandoc.table(tx2gene[1:10, ])
```

The raw sample *bam* files, *salmon* results, and *fastq* files are also provided.
...
The *tx2gene* flag can be overlooked, and the *gtf* will be used to generate a *tx2gene* dataframe.
